...
form.addEventListener('submit', (event)=>{
    ...
    API.post('/', {
        ...
        list.insertAdjacentHTML('beforeend', `<li class="card">
          <div>
            <h3 class="name">${_helpersJs.capitalize(name.value)}</h3>
            <div class="calories">${_helpersJs.calculateCalories(carbs.value, protein.value, fat.value)} calories</div>
            <ul class="macros">
...
},{"./fetch-wrapper.js":"5hTQM","./helpers.js":"ecN5O","snackbar":"nwWOh","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"5hTQM":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{}]},["7fmqN","8lqZg"], "8lqZg", "parcelRequire06db")
