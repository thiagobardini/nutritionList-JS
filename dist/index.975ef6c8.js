...
const displayEntry = (name1, carbs1, protein1, fat1)=>{
    ...
    list.insertAdjacentHTML('beforeend', `<li class="card">
        <div>
          ...
          <div class="calories">${_helpersJs.calculateCalories(carbs1, protein1, fat1)} calories</div>
          <ul class="macros">
            <li class="carbs"><div>Carbs</div><div class="value">${carbs1}g</div></li>
            <li class="protein"><div>Protein</div><div class="value">${protein1}g</div></li>
            <li class="fat"><div>Fat</div><div class="value">${fat1}g</div></li>
          </ul>
        </div>
      </li>`);
};
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"khwgE":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["7fmqN","8lqZg"], "8lqZg", "parcelRequire06db")
